(function(){  
  ...
  function initPurposeHeroAltAnimations(container) {
    const instances = [];
    ...
    whenGsapReady(function(){
      ...
      const heroAlt = root.querySelector(".purpose_hero_alt_wrap");
      ...
      const altItems = heroAlt.querySelectorAll(".purpose_hero_alt_item");
  ...
  window.initPurposeHeroAltAnimations = initPurposeHeroAltAnimations;
